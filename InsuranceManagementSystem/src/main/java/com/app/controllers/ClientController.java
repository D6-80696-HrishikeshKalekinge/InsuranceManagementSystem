...
public class ClientController {
	...
	@PutMapping("/user/{id}")
	public ResponseEntity<?> editPersonalDetailsUser(@PathVariable int id, @RequestBody PersonalDetailsDTO personalDetailsDTO) {
		//TODO: process PUT request
		
		return ResponseEntity
				.status(HttpStatus.OK)
				.body(clientService.editPersonalDetailsUser(personalDetailsDTO, id));
	}
